...
# yapf: disable
# from mmcv.ops import (Conv2d, ConvTranspose2d, ConvWS2d,
...
from .box_iou_rotated.box_iou_rotated_C import box_iou_rotated
...
__all__ = [
    ...
    # 'MaskedConv2d', 'GeneralizedAttention', 'NonLocal2D',
