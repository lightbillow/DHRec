...
class TextDataset(XMLDataset):
    ...
    def load_annotations(self, ann_file):
        ...
        self.img_ids = [img_id[:-4] for img_id in img_ids]
        for img_id in img_ids:
            filename = 'images/{}'.format(img_id)
            ...
            img_infos.append(
                dict(id=img_id[:-4], filename=filename, width=width, height=height))
        return img_infos
    ...
    def det2txt(self, results):
        ...
        for idx in range(len(self)):  # num images
            ...
            # img_id = 'res_' + os.path.splitext(os.path.basename(img_id))[0][3:]
            img_id = 'res_' + os.path.splitext(os.path.basename(img_id))[0]
            result = results[idx]
            ...
            for label in range(len(result)):  # num classes
                ...
                for i in range(bboxes.shape[0]):  # num boxes per class
                    ...
                    #                                                coordinate[6], coordinate[7], score))
                    line = ('{},{},{},{},{},{},{},{}'.format(coordinate[0], coordinate[1], coordinate[2],
                                                                   coordinate[3], coordinate[4], coordinate[5],
