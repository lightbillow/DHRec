...
class DOTADataset(XMLDataset):
    ...
    def __init__(self, **kwargs):
        ...
        self.min_size = 1
        # self.bbox_transform_rotate = BboxTransform_rotate()
        # self.with_rbox_mask = with_rbox_mask
    ...
    def load_annotations(self, ann_file):
        ...
        for img_id in img_ids:
            filename = 'images/{}.png'.format(img_id)
            ...
            img_infos.append(
                dict(id=img_id, filename=filename, width=1024, height=1024))
        return img_infos
    ...
    def get_ann_info(self, idx):
        ...
        for obj in root.findall('object'):
            ...
            if self.min_size:
                ...
                w = h_bbox[2] - h_bbox[0]
                h = h_bbox[3] - h_bbox[1]
                if max(h_bbox[2], h_bbox[3]) >= 1024 or min(h_bbox[0], h_bbox[1]) <= 1:
