...
class RepPointsHeadRotate(AnchorFreeHead):
    """RepPoint head.
    ...
    def _point_target_single(self,
        ...
        proposals_weights = proposals.new_zeros([num_valid_proposals, 8])
    ...
    def loss(self,
        ...
        pts_coordinate_preds_init = self.offset_to_pts(center_list,
                                                       pts_preds_init)
        if self.train_cfg.init.assigner['type'] == 'PointRotateAssigner':
