...
data_root = '/data2/nieguangtao/dataset/dota_1024_s2anet/'
# data_root = '/data2/nieguangtao/dataset/dota_1024_ms_s2anet/'
img_norm_cfg = dict(
...
data = dict(
    ...
    train=dict(
        ...
        dataset=dict(
            type=dataset_type,
            ann_file=[
                data_root + 'trainval_split/trainval_filter.txt',
            ],
            img_prefix=[data_root + 'trainval_split/'],
            pipeline=train_pipeline)),
    val=dict(
        type=dataset_type,
        ann_file=data_root + 'trainval_split/trainval_filter.txt',
        img_prefix=data_root + 'trainval_split/',
        pipeline=test_pipeline),
    test=dict(
        type=dataset_type,
        ann_file=data_root + 'test_split/test.txt',
