...
def main():
    ...
    # detpath = os.path.join(r'work_dirs/atss/doublebbox/train_two/Res50_torch_doublebbox_matching_three_smoothl1/det_cls_result_nms') + '/Task1_{:s}.txt'
    # annopath = r'/data1/nieguangtao/dataset/DOTA/val/labelTxt/{:s}.txt'
    # imagesetfile = r'/data1/nieguangtao/dataset/DOTA/val.txt'

    detpath = os.path.join(r'work_dirs/atss/addexper/Res101_torch_baseline_five_params_multi/det_cls_result_nms') + '/Task1_{:s}.txt'
    annopath = r'/data1/nieguangtao/dataset/DOTA/test/labelTxt/{:s}.txt'
    imagesetfile = r'/data1/nieguangtao/dataset/DOTA/test.txt'
