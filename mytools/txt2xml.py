...
def WriterXMLFiles(filename, path, box_list, label_list, w, h, d):
    ...
    foldername.appendChild(doc.createTextNode("images"))
...
if __name__ == "__main__":
    txt_path = '/data1/nieguangtao/dataset/dota_1024_s2anet/val_split/labelTxt/'
    xml_path = '/data1/nieguangtao/dataset/dota_1024_s2anet/val_split/Annotations/'
    img_path = '/data1/nieguangtao/dataset/dota_1024_s2anet/val_split/images/'
